                ...
                <ul class="navbar-nav navbar-left">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-left pullDown">
                            ...
                            <a href="{{ route('profile',Auth::user()-> id) }}" class="dropdown-item has-icon"> <i
                                    class="far
										fa-user"></i> الصفحة الشخصية
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('home') }}"> <img alt="image" src="assets/img/logo.png"
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><span>الاعلانات</span>
                                <i data-feather="briefcase"></i></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('adv-all') }}">كل الإعلانات</a></li>
                                <li><a class="nav-link" href="{{ route('create') }}">اضافة اعلان</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">mande Users</li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><span>المستخدمين</span><i
                                    data-feather="users"></i></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('all.users') }}">جميع المستخدمين</a></li>
                                <li><a class="nav-link" href="{{ route('add.user') }}">اضافة مستخدم</a></li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><span>الإعدادات</span><i
