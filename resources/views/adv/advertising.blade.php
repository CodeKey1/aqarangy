                            ...
                            <div class="col-12">
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h4>مــديــر الإعــــلانــات </h4>
                                    </div>
                                    <div class="card-body" style="direction: rtl;">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover" id="save-stage"
                                                ...
                                                <tbody>
                                                    {{-- @isset($advs) --}}
                                                    @if ($advs && $advs->count() > 0)
                                                        @foreach ($advs as $Advs)
                                                            <tr>
                                                                <td>{{ $Advs->id }}</td>
                                                                <td>{{ $Advs->type }}</td>
                                                                <td>{{ $Advs->users->name }}</td>
                                                                <td>{{ $Advs->user_type }}</td>
                                                                <td>{{ $Advs->price }}
                                                                    <div class="badge badge-light">جنية</div></td>
                                                                <td>{{ $Advs->time }}</td>
                                                                <td>
                                                                    @if ($Advs->state == 0)
                                                                ...
                                                                <td>
                                                                    <div class="btn-group dropup">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                                                            <a class="dropdown-item" href="{{route('single-adv',$Advs -> id)}}">عرض</a>
                                                                            <a class="dropdown-item" href="{{route('edit-adv',$Advs -> id)}}"> تعديل</a>
