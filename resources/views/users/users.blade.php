                            ...
                            <div class="col-12">
                                ...
                                <div class="card card-secondary">
                                    <div class="card-header">
                                        <h4>مــديــر الـمـسـتـخـدمـيـن </h4>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($users as $Users)
                                                            <tr>
                                                                ...
                                                                <td>{{ $Users->type }}</td>
                                                                <td>
                                                                    <div class="badge badge-light">{{ $Users->ads->count() }}</div></td>
                                                                <td>{{ $Users->phone }}</td>
                                                                <td>
                                                                    @if ($Users->state == 0)
                                                                    <div class="badge badge-danger">غير نشط</div>
                                                                 @elseif($Users->state == 1)
                                                                ...
                                                                <td>
                                                                    <div class="btn-group dropup">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                                                            ...
                                                                            <a class="dropdown-item" href="{{route('delete.user',$Users -> id)}}">حذف</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
